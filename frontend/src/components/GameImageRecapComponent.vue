...
<template>
  <div class="flex h-screen" id="game_recap">
    ...
    <div v-if="gameStore.hasPlayed" class="h-screen basis-1/3 flex flex-col items-center justify-center gap-2" id="game_image_recap">
      ...
      <RouterLink to="/game" class="bg-gray-800 text-gray-50 w-fit px-4 py-2 rounded-3xl">Passer à l'image suivante</RouterLink>
    </div>
    <div v-else class="h-screen basis-1/3 flex flex-col items-center justify-center gap-4">
      ...
      <RouterLink to="/game" class="bg-gray-800 text-gray-50 -fit px-4 py-2 rounded-3xl">Passer à l'image suivante</RouterLink>
    </div>
  </div>
</template>
