...
class StatsService implements StatsServiceInterface
{
    ...
    {
        try{
            $stats = new Stats($inputStatsDTO->user_id, $inputStatsDTO->score_total, $inputStatsDTO->score_moyen, $inputStatsDTO->nb_parties, $inputStatsDTO->meilleur_score, $inputStatsDTO->pire_coups);
