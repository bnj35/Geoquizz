...
$pdo = new \toubeelib\infrastructure\db\PDOAuthRepository(new \PDO('pgsql:host=toubeelib.db;dbname=toubee_auth', 'root', 'root'));
$aa = $pdo->getUserByEmail('munoz.theophile@laposte.net');
var_dump($aa);
